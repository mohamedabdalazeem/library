...
const myLibrary = [
  ...
  },
  {
    ...
    pages: 180,
    coverUrl:
      "https://m.media-amazon.com/images/I/71AXNf+3M0L._AC_UF894,1000_QL80_.jpg",
    read: false,
  },
  {
    title: "Atomic Habits",
...
class Book {
  constructor(title, author, pages, coverUrl, read) {
    this.title = title;
    this.author = author;
    this.pages = pages;
...
function displayBooks() {
  ...
  myLibrary.map((book) => {
    ...
    imgEl.src =
      book.coverUrl != ""
        ? book.coverUrl
        : "https://i.pinimg.com/736x/72/c6/7a/72c67af70b9c14f254e4d56125b99873.jpg";
